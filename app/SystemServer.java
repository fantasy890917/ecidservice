...
/// @}
import com.android.server.ecid.ECIDManagerService;
...
public final class SystemServer {
    ...
    private void startBootstrapServices() {
        ...
        /// M: RecoveryManagerService  @{
        boolean disableAntiBricking = "0".equals(SystemProperties.get("ro.mtk_antibricking_level"));
        if (!disableAntiBricking) {
            try {
                ...
                if (mRecoveryManagerService != null) {
                    ServiceManager.addService(Context.RECOVERY_SERVICE,
                            mRecoveryManagerService.asBinder());
    ...
    private void startOtherServices() {
        ...
        try {
			...
			///HQ:add
			mSystemServiceManager.startService(ECIDManagerService.class);
			Slog.i(TAG, "Init ECIDManagerService");
			///HQ:add by fanta end
        ...
        if (mFactoryTestMode != FactoryTest.FACTORY_TEST_LOW_LEVEL) {
            ...
            if (false == SystemProperties.get("ro.mtk_bsp_package").equals("1")
                ...
                try {
                    ...
                    ServiceManager.addService(Context.AUDIO_PROFILE_SERVICE,
                            new AudioProfileService(context));
                } catch (Throwable e) {
