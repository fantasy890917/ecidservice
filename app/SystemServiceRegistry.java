...
final class SystemServiceRegistry {
    ...
    static {
        ...
        registerService(Context.ECID_PARSER_SERVICE, ECIDManager.class,
                new CachedServiceFetcher<ECIDManager>() {
            @Override
            public ECIDManager createService(ContextImpl ctx) {
                IBinder b = ServiceManager.getService(Context.ECID_PARSER_SERVICE);
                IECIDManager service = IECIDManager.Stub.asInterface(b);
                return new ECIDManager(service, ctx);
            }});
        ...
        if (SystemProperties.get("ro.mtk_audio_profiles").equals("1") == true
            ...
            registerService(Context.AUDIO_PROFILE_SERVICE, AudioProfileManager.class,
                    new CachedServiceFetcher<AudioProfileManager>() {
                @Override
                public AudioProfileManager createService(ContextImpl ctx) {
