/* //device/java/android/android/app/IECIDManager.aidl
**
...
interface IECIDManager {
    ...
    boolean hasCBDefaultOn();
    List<String> getCBChannelList();
    ...
    boolean voiceMailEditable();
    boolean voiceMailRoamingEditable();
    boolean disableClirValue();
